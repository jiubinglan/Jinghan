...
def parse_function(*metrics, directory="", args=None, end_signal=None):
    ...
    print(f"Found {len(subdirs)} subdirectories and they are: {subdirs}")
    outputs = []
    ...
    for subdir in subdirs:
        ...
        if output:
            ...
            print(f"No match found in {fpath} and output is {output}")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--end_signal", default="Finished training", type=str, help="end signal string"
    )    
